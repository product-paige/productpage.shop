      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="text-center mb-16">
          <motion.div
            ...
            <h1 className="text-3xl font-bold text-stone-900" style={{ fontFamily: 'Instrument Serif, serif' }}>Spotlight.shop
          ...
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }} className="text-4xl md:text-6xl font-bold text-stone-900 mb-6"

            style={{ fontFamily: 'Instrument Serif, serif' }}>All of your Affiliate links, 
in one spot.
          ...
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }} className="text-stone-600 mb-8 mx-auto text-lg max-w-2xl">Create your personalized storefront. Share all your favorite products in one place. Perfect for influencers, creators, and anyone who loves to share.
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <motion.div
            ...
            <h3 className="text-xl font-semibold text-stone-900 mb-2">All your links in one place</h3>
          ...
          <motion.div
            ...
            <h3 className="text-xl font-semibold text-stone-900 mb-2">Curated looks & collections</h3>
            <p className="text-stone-600">
          ...
          <motion.div
            ...
            <h3 className="text-xl font-semibold text-stone-900 mb-2">Track link performance</h3>
            <p className="text-stone-600">
